define("ace/mode/mediawiki_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, s = function () {
        this.$rules = {
            start: [{include: "#switch"}, {include: "#redirect"}, {include: "#variable"}, {include: "#comment"}, {include: "#entity"}, {include: "#emphasis"}, {include: "#tag"}, {include: "#table"}, {include: "#hr"}, {include: "#heading"}, {include: "#link"}, {include: "#list"}, {include: "#template"}],
            ...
            "#list": [{
                ...
                push: [{
                    ...
                    regex: /$/,
                    next: "pop"
                }, {include: "$self"}, {defaultToken: "markup.list"}]
            }],
            "#template": [{
                ...
                push: [{
                    ...
                    push: [{
                        ...
                        regex: /(?=}}|[|])/,
                        next: "pop"
                    }, {include: "$self"}, {defaultToken: "meta.template.value"}]
            ...
            "#link": [{
                ...
                push: [{
                    ...
                    regex: /\]\]/,
                    next: "pop"
                }, {include: "$self"}, {defaultToken: "meta.tag.link.internal"}]
            }, {
            ...
            "#tag": [{
                ...
                push: [{
                    ...
                    caseInsensitive: !0,
                    next: "pop"
                }, {include: "$self"}, {defaultToken: "meta.tag.block.ref"}]
            }, {
                ...
                push: [{
                    ...
                    regex: /((?:\/)?)(>)/,
                    next: "pop"
                }, {include: "#attribute"}, {defaultToken: "meta.tag.block.any"}]
            }, {
                token: ["punctuation.definition.tag.begin", "entity.name.tag"],
                ...
                push: [{
                    ...
                    regex: /\/?>/,
                    next: "pop"
                }, {include: "#attribute"}, {defaultToken: "meta.tag.other"}]
            }, {
                token: ["punctuation.definition.tag.begin", "entity.name.tag"],
                ...
                push: [{
                    ...
                    regex: /((?:\/)?)(>)/,
                    next: "pop"
                }, {include: "#attribute"}, {defaultToken: "meta.tag.block"}]
            }, {
            ...
            "#th": [{
                ...
                push: [{
                    ...
                    regex: /(!!)(?:(.*?)(\|))?(.*?)(?=!!|$)/
                }, {include: "$self"}, {defaultToken: "meta.tag.block.th.heading"}]
            }],
            "#td": [{
                ...
                push: [{
                    ...
                    regex: /$/,
                    next: "pop"
                }, {include: "$self"}, {defaultToken: "meta.tag.block.td"}]
            }],
            "#table": [{
                patterns: [{
                    ...
                    patterns: [{include: "#comment"}, {include: "#template"}, {include: "#caption"}, {include: "#tr"}, {include: "#th"}, {include: "#td"}]
                }], repository: {
                    caption: {
                    ...
                    tr: {
                        ...
                        match: "^\\s*(\\|\\-)[\\s]*(.*)",
                        captures: {1: {name: "punctuation.definition.tag.begin"}, 2: {name: "invalid.illegal"}}
                    },
                    th: {
            ...
            "#attribute": [{include: "#string"}, {token: "entity.other.attribute-name", regex: /\w+/}],
            "#string": [{
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./mediawiki_highlight_rules").MediaWikiHighlightRules,
        o = function () {
            this.HighlightRules = s
        };
    r.inherits(o, i), function () {
        this.type = "text", this.blockComment = {start: "<!--", end: "-->"}, this.$id = "ace/mode/mediawiki"
