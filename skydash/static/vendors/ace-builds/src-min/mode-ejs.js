define("ace/mode/css_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    t.qString = {token: "string", regex: "['](?:(?:\\\\.)|(?:[^'\\\\]))*?[']"}, t.qqString = {
        token: "string",
        regex: '["](?:(?:\\\\.)|(?:[^"\\\\]))*?["]'
    ...
    var o = t.constantNumericHex = {
        ...
        }, u = t.constantNumericBinary = {token: "constant.numeric", regex: /\b(0[bB][01](?:[01]|_(?=[01]))*)\b/},
        a = t.constantNumericDecimal = {token: "constant.numeric", regex: /\b(0[dD](?:[1-9](?:[\d]|_(?=[\d]))*|0))\b/},
        f = t.constantNumericDecimal = {
            token: "constant.numeric",
            regex: /\b(0[oO]?(?:[1-7](?:[0-7]|_(?=[0-7]))*|0))\b/
        }, l = t.constantNumericRational = {token: "constant.numeric", regex: /\b([\d]+(?:[./][\d]+)?ri?)\b/},
        c = t.constantNumericComplex = {token: "constant.numeric", regex: /\b([\d]i)\b/}, h = t.constantNumericFloat = {
            token: "constant.numeric",
            regex: "[+-]?\\d(?:\\d|_(?=\\d))*(?:(?:\\.\\d(?:\\d|_(?=\\d))*)?(?:[eE][+-]?\\d+)?)?i?\\b"
        }, p = t.instanceVariable = {token: "variable.instance", regex: "@{1,2}[a-zA-Z_\\d]+"}, d = function () {
            ...
            this.$rules = {
                start: [{token: "comment", regex: "#.*$"}, {
                    ...
                    regex: /(:)?(")/,
                    push: [{token: "constant.language.escape", regex: d}, {
                        token: "paren.start",
                        regex: /#{/,
                        push: "start"
                    ...
                    token: "string.start", regex: /%[qwx]([(\[<{^|%])/, onMatch: function (e, t, n) {
                        n.length && (n = []);
                        var r = e[e.length - 1];
                    ...
                    token: "constant.other.symbol.ruby", regex: /%[si]([(\[<{^|%])/, onMatch: function (e, t, n) {
                        n.length && (n = []);
                        var r = e[e.length - 1];
                    ...
                    token: "string.regexp", regex: /%[r]([(\[<{^|%])/, onMatch: function (e, t, n) {
                        n.length && (n = []);
                        var r = e[e.length - 1];
                        return n.unshift(r, t), this.next = "rState", this.token
                    }
                }], {token: "punctuation", regex: "::"}, p, {
                    ...
                    token: "punctuation.operator",
                    regex: /\?(?=.+:)/
                }, l, c, s, o, h, u, a, f, {token: "constant.language.boolean", regex: "(?:true|false)\\b"}, {
                    token: i,
                    regex: "[a-zA-Z_$][a-zA-Z0-9_$]*\\b"
                }, {token: "punctuation.separator.key-value", regex: "=>"}, {
                    stateName: "heredoc",
                    onMatch: function (e, t, n) {
                        var r = e[2] == "-" || e[2] == "~" ? "indentedHeredoc" : "heredoc", i = e.split(this.splitRegex);
                ...
                }, {token: "text", regex: "\\s+"}, {token: "punctuation.operator", regex: /[?:,;.]/}],
                comment: [{token: "comment.multiline", regex: "^=end(?=$|\\s.*$)", next: "start"}, {
                    token: "comment",
                    regex: ".+"
                }],
                qStateWithInterpolation: [{
                    token: "string.start", regex: /[(\[<{]/, onMatch: function (e, t, n) {
                ...
                qStateWithoutInterpolation: [{
                    ...
                    token: "string.end", regex: /[)\]>}^|%]/, onMatch: function (e, t, n) {
                        return n.length && e === v[n[0]] ? (n.shift(), this.next = n.shift(), this.token) : (this.next = "", "string")
                    }
                }, {defaultToken: "string"}],
                sStateWithoutInterpolation: [{
                    ...
                    token: "constant.other.symbol.ruby", regex: /[)\]>}^|%]/, onMatch: function (e, t, n) {
                ...
                rState: [{
                    token: "string.regexp", regex: /[(\[<{]/, onMatch: function (e, t, n) {
                    ...
                    token: "string.regexp", regex: /[)\]>}^|%][imxouesn]*/, onMatch: function (e, t, n) {
                        return n.length && e[0] === v[n[0]] ? (n.shift(), this.next = n.shift(), this.token) : (this.next = "", "constant.language.escape")
                    }
                }, {include: "regex"}, {defaultToken: "string.regexp"}],
                regex: [{token: "regexp.keyword", regex: /\\[wWdDhHsS]/}, {
                    token: "constant.language.escape",
                    regex: /\\[AGbBzZ]/
                }, {
                    token: "constant.language.escape",
    ...
    r.inherits(u, i), function () {
        this.indentKeywords = {
            ...
            var i = new o(e, t, n), u = i.getCurrentToken();
            if (!u || u.type != "keyword" && u.type != "comment.multiline") return;
            var a = u.value, f = e.getLine(t);
            switch (u.value) {
                case"if":
                case"unless":
                case"while":
            ...
            var h = [a];
            if (!c) return;
            var p = c === -1 ? e.getLine(t - 1).length : e.getLine(t).length, d = t, v = [];
    ...
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./ruby_highlight_rules").RubyHighlightRules,
        ...
        a = e("./behaviour/cstyle").CstyleBehaviour, f = e("./folding/ruby").FoldMode, l = function () {
