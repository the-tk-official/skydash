    ...
    var r = e("../lib/event"), i = e("../lib/useragent"), s = e("../lib/dom"), o = e("../lib/lang"),
        ...
        p = h.KEY_MODS, d = i.isIOS, v = d ? /\s/ : /\n/, m = i.isMobile, g = function (e, t) {
            ...
            var P = !1, H = function (e, r) {
                ...
                var s = n.selectionStart, o = n.selectionEnd, u = N, a = T.length - C, f = e, l = e.length - s,
                    c = e.length - o, h = 0;
    ...
    t.addTouchListeners = function (e, t) {
        ...
        function w() {
            ...
            var e = t.selection.cursor, n = t.renderer.textToScreenCoordinates(e.row, e.column),
                r = t.renderer.textToScreenCoordinates(0, 0).pageX, i = t.renderer.scrollLeft,
        ...
        i.addListener(e, "contextmenu", function (e) {
            ...
            if (y - a < 500 && i.length == 1 && !h) d++, e.preventDefault(), e.button = 0, x(); else {
                ...
                var N = t.selection.cursor, C = t.selection.isEmpty() ? N : t.selection.anchor,
                    ...
                    A = t.renderer.scroller.getBoundingClientRect(), O = t.renderer.layerConfig.offset,
                    M = t.renderer.scrollLeft, _ = function (e, t) {
    ...
    w.$uid = 0, function () {
        r.implement(this, d), this.$initOperationListeners = function () {
            ...
            this.$highlightTagPending = !0, setTimeout(function () {
                ...
                var s = i.value, o = i.value, u = 0, a = r.stepBackward();
                if (a.value === "<") {
                ...
                var h = r.getCurrentTokenRow(), d = r.getCurrentTokenColumn(), v = new p(h, d, h, d + i.value.length),
